...
export const Enigmar: CustomMonster = {
	...
	allItems: resolveItems(['Enigmatic orb', "Mini 'mar"]),
	minimumGearRequirements: {
		melee: {}
	},
	minimumWeaponShieldStats: {
		mage: addStatsOfItemsTogether(resolveItems(['Kodai wand', 'Arcane spirit shield']), [GearStat.AttackMagic])
	},
	itemCost: {
